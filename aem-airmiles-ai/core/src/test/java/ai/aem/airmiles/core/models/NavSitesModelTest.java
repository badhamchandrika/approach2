...
public class NavSitesModelTest {

    private NavSitesModel fixture;
    ...
    @BeforeEach
    void setUp() {
        aemContext.addModelsForClasses(NavSitesModel.class);
        aemContext.create().resource("/content/navsites", ImmutableMap.<String, Object>builder()
                .put("sites",
                ...
                .build());
        aemContext.currentResource("/content/navsites");
        fixture = aemContext.request().adaptTo(NavSitesModel.class);
