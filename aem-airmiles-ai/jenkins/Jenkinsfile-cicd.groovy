...
if (JENKINS_PIPELINE_ID != 'ci' && JENKINS_PIPELINE_ID != 'dev' && JENKINS_PIPELINE_ID != 'qa' && JENKINS_PIPELINE_ID != 'staging' && JENKINS_PIPELINE_ID != 'hotfix_ci' && JENKINS_PIPELINE_ID != 'hotfix_staging') error("JENKINS_PIPELINE_ID string parameter in jenkins needs to be either 'code_quality', 'hotfix_code_quality', 'hotfix_staging', 'dev', 'qa' or 'staging'")


// GLOBAL STATIC Variables
EMAIL_RECIPIENTS = 'gmalagondla@loyalty.com,dlakshmipathy@loyalty.com,JManrique@loyalty.com,jesus.manrique@globant.com'
L1_REPO_NAME = 'aem-airmiles-ai'
MICROSOFT_TEAMS_PROJECT_WEBHOOK = 'https://loyaltyone.webhook.office.com/webhookb2/4ae3608e-c99e-4db2-9841-785844c0af42@a9f9458b-a469-48c4-9a71-806e262869bf/JenkinsCI/94a8b4b6429548c9837cb234bff157c7/d2c38951-021d-44f7-ab9f-8872d53c7b44'

L1_REPO_TRUNK='main'
ADOBE_REPO_TRUNK='main'
ADOBE_REPO_ID=105206
//test-deployment
...
def JENKINS_PIPELINES = [
        ci:        [adobePipelineId: '10991402',  mutex: "${L1_REPO_NAME}-ci",          deployStageName: 'Adobe Code Quality Scan'],
        hotfix_ci: [adobePipelineId: '10989956',  mutex: "${L1_REPO_NAME}-hotfix-ci",   deployStageName: 'Hotfix Adobe Code Quality Scan'],
                ...
                failure {
                    script {
                        notifyParties(String.format(
                                ...
                                automationStatus,
                                env.STAGE_NAME,
                                "Error: (L1 SonarQube Build Failed",
                                releaseVersion,
                                getLastCommitAuthor()
                        ), '#FF0000')
                    }
            ...
            script {
                ...
                if (JENKINS_PIPELINE_ID == 'ci' && !isJenkinsCommit()) {
                    ...
                    build job:"aem-projects/${L1_REPO_NAME}/cd-qa", parameters: [
                            ...
                            wait: false
                } else if (JENKINS_PIPELINE_ID == 'qa') {
